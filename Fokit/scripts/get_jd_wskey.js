...
================Quantumult X配置=================
[rewrite_local]
^https:\/\/api\.m\.jd\.com\/client\.action\?functionId=newUserInfo url script-response-body https://raw.githubusercontent.com/axtyet/Quan-X/main/FoKit/scripts/get_jd_wskey.js
...
====================Surge配置====================
[Script]
京东 WSKEY = type=http-response,pattern=^https:\/\/api\.m\.jd\.com\/client\.action\?functionId=newUserInfo,requires-body=1,max-size=0,timeout=1000,script-path=https://raw.githubusercontent.com/axtyet/Quan-X/main/FoKit/scripts/get_jd_wskey.js,script-update-interval=0
...
====================Loon配置=====================
[Script]
http-response ^https:\/\/api\.m\.jd\.com\/client\.action\?functionId=newUserInfo tag=京东 WSKEY, script-path=https://raw.githubusercontent.com/axtyet/Quan-X/main/FoKit/scripts/get_jd_wskey.js,requires-body=1
